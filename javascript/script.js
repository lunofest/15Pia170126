...
function updateTimer() {
  const targetDate = new Date("january 17, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543541543441'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543541543219'; // Número para el primer botón
  const recipientNumber2 = '543541543441'; // Número para el segundo botón
